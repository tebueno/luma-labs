# LogicFlow Shopify App

Vertical slice implementation of the LogicFlow checkout validation engine.
...
3. Find "LogicFlow Validator" and enable it

### 6. Test It!

1. Open the LogicFlow app in your store's admin
...
```bash
shopify app function logs --name=logicflow-validator
```

Or in the Partner Dashboard:
**Apps > LogicFlow > Extensions > logicflow-validator > Logs**

### Build function manually

```bash
cd extensions/logicflow-validator
