# **Technical Requirements Document (TRD): Gatekeep**
...
│     └── JSON stored in shop.metafield(gatekeep.rules_config)       │
└─────────────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────────────┐
│                        EXECUTION LAYER                              │
...
**Philosophy:** Fail-open. Never block checkout due to Gatekeep errors. Log everything for debugging.
